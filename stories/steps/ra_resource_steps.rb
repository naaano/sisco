...
steps_for(:ra_resource) do
  ...
  #   "Given a usuario with login: 'mojojojo'" 
  # produces a Usuario instance stored in @usuario with 'mojojojo' as its login
  # attribute.
  #
  ...
  #   "And the usuario has thac0: 3"
  # takes the earlier-defined @usuario instance and sets its thac0 to '3'.
  #
...
#
# So, for instance,
#   klass, instance = parse_resource_args 'usuario'
#   instance = klass.new({login => 'me', password => 'monkey', ...})
#   keep_instance! resource, instance
# keeps the just-constructed Usuario model in the @usuario instance variable.
#
